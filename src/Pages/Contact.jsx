export default function Contact() {
  return (
    <section className="py-20 px-6 bg-pink-400  w-full min-h-screen">
      <div className="max-w-5xl mx-auto items-center-safe">
        <h2 className="text-2xl font-bold text-center mb-11">Hubungi Saya</h2>
        ...
        <div className="grid md:grid-cols-3 gap-10 text-center">
          ...
          <div className="flex flex-col items-center">
            ...
            <p className="text-gray-200">
              <a href="https://wa.me/6285741137259">+62 857 4113 7259</a>
            </p>
          </div>
